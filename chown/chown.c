 ...
 * Changes by the heirloom-ports project (https://github.com/chickazee4/heirloom-ports) 2021+
 */
/*
...
#define	USED
#endif
static const char sccsid[] USED = "@(#)chown.sl	1.14.1 (heirloom-ports) 2021";
