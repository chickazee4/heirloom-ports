...
extern	char *	auxf(char *, int);
extern	int 	chkid(char *, char *);
extern	void 	chksid(char *, struct sid *);
...
extern	char 	del_ab(char *, struct deltab *, struct packet *);
extern	void 	get_Del_Date_time(char *, struct deltab *, struct packet *, struct tm *);
extern	char *	del_ba(struct deltab *, char *);
extern	struct idel *	dodelt(struct packet *, struct stats *, struct sid *, int);
extern	void 	do_file(char *, void (*)(char *), int);
extern	void 	dohist(char *);
extern	int 	valmrs(struct packet *, char *);
extern	void 	mrfixup(void);
extern	char *	stalloc(unsigned int);
extern	char *	savecmt(char *);
extern	char *	get_Sccs_Comments(void);
extern	void 	doie(struct packet *, char *, char *, char *);
extern	void 	dolist(struct packet *, char *, int);
extern	int 	eqsid(struct sid *, struct sid *);
extern	void 	flushto(struct packet *, int, int);
extern	void 	fmterr(struct packet *);
#undef getline
#define getline	xxgetline
extern	char *	getline(struct packet *);
extern	int 	getser(struct packet *);
extern	char *	logname(void);
extern	void 	newsid(struct packet *, int);
extern	void 	newstats(struct packet *, char *, char *);
extern	void 	finduser(struct packet *);
extern	void 	doflags(struct packet *);
extern	void 	permiss(struct packet *);
extern	void 	pf_ab(char *, struct pfile *, int);
extern	void 	putline(struct packet *, char *);
extern	void 	flushline(struct packet *, struct stats *);
...
extern	void 	setup(struct packet *, int);
extern	void 	condset(struct apply *, int, int);
extern	char *	sid_ab(char *, struct sid *);
extern	char *	omit_sid(char *);
extern	char *	sid_ba(struct sid *, char *);
extern	int 	sidtoser(struct sid *, struct packet *);
extern	void 	sinit(struct packet *, char *, int);
extern	void 	stats_ab(struct packet *, struct stats *);
