...
#define	USED
#endif
static const char sccsid[] USED = "@(#)su.sl	1.25.1 (heirloom-ports) 2021";
...
// static const char	defaultfile[] = SUDFL;  (deprecated in heirloom-ports)
...
defaults(void)
{
	/* This section not really needed in modern applications
	FILE *fp;
